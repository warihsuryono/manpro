...
<head>
    <title>Grafik Batang sampah</title>
        ...
        var myChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: [
                        <?php
                        $jumlah_organik = mysqli_query($koneksi, "select * from sampah where jenis='organik'");
                        echo mysqli_num_rows($jumlah_organik);
                        ?>,
                        <?php
                        $jumlah_nonorganik = mysqli_query($koneksi, "select * from sampah where jenis='nonorganik'");
